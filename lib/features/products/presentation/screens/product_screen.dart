...
import 'package:teslo_app/features/products/presentation/providers/forms/product_form_provider.dart';
import 'package:teslo_app/features/products/presentation/providers/product_provider.dart';
import 'package:teslo_app/features/shared/widgets/full_screen_loader.dart';
        ...
        children: [
          ...
          CustomProductField(
            ...
            onChanged: (value) => ref
                ...
                .onPriceChange(double.tryParse(value) ?? 0),
          ...
          CustomProductField(
            ...
            onChanged: (value) => ref
                .read(productFormProvider(product).notifier)
                .onStockChange(int.tryParse(value) ?? 0),
